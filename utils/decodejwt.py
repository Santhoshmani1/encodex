...
def decode_jwt(jwt_token):
    ...
    if len(parts) < 2 or len(parts) > 3:
        raise ValueError("Invalid JWT structure. A JWT must have two or three parts separated by dots.")
    ...
    try:
        ...
        if not alg:
            print("Warning: No 'alg' (algorithm) field found in the header. This JWT might be unsigned.")
